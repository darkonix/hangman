...
(function() {
  $("#user_form").on("ajax:error", function(e, data, status, xhr) {
    return "#user_form".hide();
  });
...
(function() {
  $(function() {
    return $(".all_disseminators").click(function() {
      var status;
      status = null;
      if ($(".all_disseminators").is(':checked')) {
        status = 'checked';
      }
